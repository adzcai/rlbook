...
The DAgger algorithm ({cite}`ross_reduction_2010`) assumes that we have _query access_ to the expert policy.
...
A full proof can be found in {cite}`ross_reduction_2010` that under certain assumptions,
