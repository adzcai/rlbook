...
\addbibresource{\main/assets/main.bib}
...
\begin{definition}{Pure exploration}
...
\begin{definition}{Explore-then-commit}
:name: etc
...
\begin{example}{Bayesian Bernoulli bandit}
:name: bayesian_bernoulli
