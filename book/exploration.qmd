...
There are $|\mathcal{S}|$ cells arranged in a strip.
...
Of course,
a simple way to solve the "strip MDP" in @exm-sparse-reward-mdp
...
$$
\E \left[ \sum_{\ep = 0}^{\Ep - 1} \left(V^\star_0(s_0) - V^{\pi^\ep}_0(s_0) \right) \right] = \widetilde{O}(H^2 \sqrt{|\mathcal{S}| |\mathcal{A}| T})
$$
:::
