...
Policy iteration (@sec-policy-iteration) and iterative LQR (@sec-iterative-lqr)
...
| @sec-fitted-dp (Fitted DP) | arbitrary | $\{ 1, \dots, \vert \mathcal{A} \vert \}$ | deterministic | unknown | Q-learning, fitted policy iteration |
...
Compare this with the policy iteration update (@sec-policy-iteration),
