...
Note that this also gives simplified forms of the @bellman_consistency for the optimal policy:
...
is exactly the same as @iterative_pe! This is because value iteration is simply
