...
over sequences of actions and states $(s_0, a_0, \dots, s_{\hor-1}, a_{\hor-1})$
can be written as

$$
\rho^{\pi}(\tau) := d_0(s_0) \pi_0(a_0 \mid s_0) P(s_1 \mid s_0, a_0) \cdots
P(s_{\hor-1} \mid s_{\hor-2}, a_{\hor-2}) \pi_{\hor-1}(a_{\hor-1} \mid s_{\hor-1}).
