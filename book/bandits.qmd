...
## Pure exploration {#sec-pure_exploration}
...
It turns out that setting $\epsilon_t = \sqrt[3]{K \ln(t)/t}$ also achieves a regret of $\tilde O(t^{2/3} K^{1/3})$ (ignoring the logarithmic factors). (We will not prove this here; a proof can be found in @agarwal_reinforcement_2022.)
...
## Thompson sampling and Bayesian bandits {#sec-thompson_sampling}
...
### Linear contextual bandits {#sec-lin_ucb}
