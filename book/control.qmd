...
as we did in @sec-opt-dynamic-programming for MDPs.
...
in a very similar way to the DP algorithms in @sec-eval-dp.
...
The construction (and inductive proof) proceeds similarly to the one in the MDP setting (@sec-eval-dp).
