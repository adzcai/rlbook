...
| :-------: | :-----------------------------------------------: | :------------------------------------------------------------- |
|    $s$    |                   $\mathcal{S}$                   | A state.                                                       |
|           |                   $\mathcal{S}_\text{\hor}$       | A state with timestep information (i.e. $\mathcal{S}_\text{\hor} = \mathcal{S} \times [\hor]$)                                                        |
|    $a$    |                   $\mathcal{A}$                   | An action.                                                     |
|    $r$    |                       $\R$                        | A reward.                                                      |
| $\gamma$  |                     $[0, 1]$                      | A discount factor.                                             |
|  $\tau$   |                   $\mathcal{T}$                   | A trajectory $(s_0, a_0, r_0, \dots)$                                                  |
|           |                   $\mathcal{T}_\hi$               | A trajectory.                                                  |
